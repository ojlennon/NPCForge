...
const app = express();
const privateKey: string = fs.readFileSync('/etc/letsencrypt/live/express-npcforge.cloud303.tech/privkey.pem', 'utf8');
const certificate: string = fs.readFileSync('/etc/letsencrypt/live/express-npcforge.cloud303.tech/fullchain.pem', 'utf8');
const ca: string = fs.readFileSync('/etc/letsencrypt/live/express-npcforge.cloud303.tech/chain.pem', 'utf8');
...
const io = new Server(server, {
  cors: {
    origin: 'https://npcforge.cloud303.tech',
    methods: ['GET', 'POST'],
    credentials: true
  }
});

const allowedOrigins = ['http://localhost:3000','http://localhost:5174', 'https://express-npcforge.cloud303.tech', 'https://npcforge.cloud303.tech'];
